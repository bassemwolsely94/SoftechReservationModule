...
class ShortageItem(models.Model):
    ...
    # Raw name as entered/scanned/spoken
    ...
    # Per-item input source (more granular than the list-level source)
    source           = models.CharField(max_length=10, choices=SOURCE_CHOICES,
                                        default='manual', verbose_name='مصدر الإدخال')
    ...
    confirmed_by     = models.ForeignKey(
        ...
        null=True, blank=True, related_name='confirmed_shortage_items',
    ...
    class Meta:
        ...
        ordering            = ['raw_name']
        indexes = [
            models.Index(fields=['shortage_list', 'is_confirmed'],
                         name='si_list_confirmed_idx'),
            models.Index(fields=['item'], name='si_item_idx'),
        ]
